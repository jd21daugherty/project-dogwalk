...
var _followRedirects;

function _load_followRedirects() {
  return _followRedirects = _interopRequireDefault(require('follow-redirects'));
}
...
(_followRedirects || _load_followRedirects()).default.maxBodyLength = 50 * 1024 * 1024; // 50 MB
